...
compare output to inteded output > cost function (cross entropy)
optimization function (optimizer)> minimize cost(Adam optimizer/ SGD(Stocastic Gradient Descent)/AdaGrad) (8 in TF)
